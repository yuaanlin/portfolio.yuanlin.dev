...
import WorkDetail from "../../../components/Desktop/WorkDetail/WorkDetail";
import WorkList from "../../../components/Desktop/WorkList/WorkList";
...
export default class DevPortfolio extends React.Component<
    Props,
    State
> {
        ...
        return (
            ...
            >
                <Row>
                    <Col
                        lg={4}
                        style={{ height: "80vh", paddingLeft: "10%" }}
                    >
                        <div className="des">
                            <Raising
                                active={page === this.pageCode}
                                delay={
                                    page === this.pageCode ? 600 : 450
                                }
                            >
                ...
                <WorkDetail
                    watching_work={this.state.watchingWork}
                    watchingWork_opened={
                        this.state.watchingWork_opened
                    }
